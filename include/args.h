...
public:
  ...
  SwitchArg no_chunk_cache_arg_, partition_arg_, rescale_emissions_arg_, cache_naive_seqs_arg_, no_fwd_arg_, cache_naive_hfracs_arg_, only_cache_new_vals_arg_;
