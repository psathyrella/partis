...
int usage()
{
    ...
    fprintf(stderr, "         -E INT    gap extension [1]\n");
    fprintf(stderr, "         -k INT    Number to keep [1]\n");
    fprintf(stderr, "         -d INT    Max dropoff [0]\n");
...
int main(int argc, char *argv[])
{
    ...
    while((c = getopt(argc, argv, "A:B:O:E:k:d:@:j:h?")) >= 0) {
        switch(c) {
            ...
            case 'O': gap_o = atoi(optarg); break;
            case 'E': gap_e = atoi(optarg); break;
