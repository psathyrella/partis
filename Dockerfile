...
COPY . /partis
WORKDIR /partis
RUN ./bin/build.sh with-simulation  # run this script with no arguments if you don't care about simulation, and it'll skip a compilation step (which is SLOOOOOOOOOOOW)
