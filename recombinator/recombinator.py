...
class Recombinator(object):
    """ Simulates the process of VDJ recombination """
    def __init__(self, datadir, human, naivety, only_genes='', total_length_from_right=0, apply_shm=True):  # yes, with a y!
        ...
        print '    reading version freqs from %s' % (self.datadir + '/' + self.human + '/' + self.naivety + '/' + utils.all_column_fname)
        self.read_vdj_version_freqs(self.datadir + '/' + self.human + '/' + self.naivety + '/' + utils.all_column_fname)
