...
class PartitionDriver(object):
    ...
    def calc_tree_metrics(self, annotation_dict, annotation_list=None, cpath=None):
        ...
        treeutils.calculate_tree_metrics(self.args, self.args.selection_metrics_to_calculate, annotation_dict, self.args.lb_tau, lbr_tau_factor=self.args.lbr_tau_factor, cpath=cpath, reco_info=self.reco_info, treefname=self.args.treefname,
