...
class Recombinator(object):
    ...
    def __init__(self, args, total_length_from_right=-1):
        ...
        if self.args.naivety == 'M':  # read shm info if non-naive is requested
            ...
            with opener('r')(self.args.hackey_extra_data_dir + '/trees.tre') as treefile:  # read in the trees that were generated by tree-gen.r
                self.trees = treefile.readlines()

        if os.path.exists(self.args.outfname):
            os.remove(self.args.outfname)
        elif not os.path.exists(os.path.dirname(self.args.outfname)):
