...
xtitles = {
    ...
    'j_mean-n-muted' : 'N mutations (nuc)',
    ...
    'all-mean-freq' : 'mutation freq (nuc)',
    'v-mean-freq' : 'mutation freq (nuc)',
    'd-mean-freq' : 'mutation freq (nuc)',
    'j-mean-freq' : 'mutation freq (nuc)',
    'all_mean-freq' : 'mutation freq (nuc)',
    'v_mean-freq' : 'mutation freq (nuc)',
    'd_mean-freq' : 'mutation freq (nuc)',
    'j_mean-freq' : 'mutation freq (nuc)',
