...
args.istartstoplist = utils.get_arg_list(args.istartstoplist, intify=True, list_of_lists=True)
args.humans = utils.get_arg_list(args.humans)
args.hfrac_bound_list = utils.get_arg_list(args.hfrac_bound_list, floatify=True, list_of_lists=True)
