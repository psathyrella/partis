...
istartstoplist="71000:101000"  #  2500:4000"
...
#     # ./bin/compare-partition-methods.py --actions write-plots --istartstop $istartstop $leaf_mut_hum --expected-methods seed-partition:seed-naive-hamming-partition $xtra &  # --count-distances & --no-similarity-matrices 
#     # break
# done
