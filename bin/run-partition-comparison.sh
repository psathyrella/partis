...
# for istartstop in 0:100 100:600 600:1350 1350:2350 2350:3850 3850:5850 5850:8850 8850:12850 12850:17850; do  # see code below to generate these
for istartstop in 8850:12850; do # 12850:17850; do
...
# istart=0
# for s in 100 500 750 1000 1500 2000 3000 4000 5000; do
#     ((istop = istart + s))
#     echo -n " $istart:$istop"
#     ((istart += s))
# done
