...
# ./bin/compare-partition-methods.py --actions simulate $leaf_mut_hum $xtra --n-sim-seqs 10000 &
...
# ./bin/compare-partition-methods.py --actions write-plots --expected-methods vollmers-0.9:partition:naive-hamming-partition:vsearch-partition $leaf_mut_hum $xtra --n-to-partition 1000 --no-similarity-matrices
done
done
exit 0
