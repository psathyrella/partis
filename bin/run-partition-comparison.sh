...
xtra="--seed-cluster-bounds 10:15"  # "--zipf"
...
istartstoplist="1500:2500"  #  2500:4000"
...
for istartstop in $istartstoplist; do  # see code below to generate these
    ...
    # ./bin/compare-partition-methods.py --actions vsearch-partition:run-viterbi:seed-partition --istartstop $istartstop $leaf_mut_hum $xtra
    ./bin/compare-partition-methods.py --actions seed-partition:seed-naive-hamming-partition --istartstop $istartstop $leaf_mut_hum $xtra &
    ...
    # ./bin/compare-partition-methods.py --actions write-plots --istartstop $istartstop $leaf_mut_hum --expected-methods vsearch-partition --no-similarity-matrices $xtra &  # --count-distances &
    # break
done
