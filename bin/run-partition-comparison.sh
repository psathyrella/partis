...
istartstoplist="0:30"  #366000:516000"  #71000:101000"  #0:2000"
xtra="$xtra --seed-cluster-bounds 3:5"
...
for istartstop in $istartstoplist; do  # see code below to generate these
    ...
    ./bin/compare-partition-methods.py --actions annotate-seed-clusters --istartstop $istartstop $leaf_mut_hum $xtra --overwrite &
    # break
done
