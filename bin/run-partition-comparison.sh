...
istartstoplist="101000:141000"  #1500:2500" #71000:101000" #  #  #  2500:4000"
...
for istartstop in $istartstoplist; do  # see code below to generate these
    ...
    ./bin/compare-partition-methods.py --actions write-plots --istartstop $istartstop $leaf_mut_hum --expected-methods seed-partition $xtra &  # --count-distances & --no-similarity-matrices 
    # break
done
