...
if args.action == 'plot':
    ...
    n_query_list =                        [100, 200, 500, 1000, 1500, 2000, 3000, 5000, 10000, 12000, 15000, 20000, 50000, 75000]
    timeinfo['vollmers-0.9'] =            [30,   34,  43,  218,  396,  217,  398,  534,   635,  None,  None,  2247,  4152,  5589]
