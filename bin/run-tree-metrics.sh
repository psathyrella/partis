...
# echo $bin --label vary-obs-times-v4 --n-replicates 30 --n-sim-events-per-proc 10 --min-target-distance-list 2 --carry-cap-list 350:1000:2000 --obs-times-list 50,100,150,200,250:100,200,300,400,500:200,400,600,800,1000:600,1200,1800,2400,3000 --n-sim-seqs-per-gen-list 20 --lb-tau-list 0.0025 --final-plot-xvar obs-times --include-relative-affy-plots $common --pvks-to-plot 1000  # full carry-cap-list 250:350:500:1000:2000
echo $bin --label vary-obs-times-v5 --n-replicates 30 --n-sim-events-per-proc 10 --min-target-distance-list 2 --carry-cap-list 350:1000:2000 --obs-times-list 50:100:250:500:1000:3000 --n-sim-seqs-per-gen-list 100 --lb-tau-list 0.0025 --final-plot-xvar obs-times $common --pvks-to-plot 350  # full carry-cap-list 250:350:500:1000:2000
