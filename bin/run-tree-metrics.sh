...
echo $bin --label choose-among-families-v2 --n-replicates 10 --n-sim-events-per-proc 30  $common --carry-cap-list 1500 --obs-times-list 150 --n-sim-seqs-per-gen-list 150 --selection-strength 0.75 --lb-tau-list 0.0025 --dont-observe-common-ancestors --parameter-variances selection-strength,0.5 --choose-among-families
echo $bin --label choose-among-families-v3 --n-replicates 10 --n-sim-events-per-proc 30  $common --carry-cap-list 1500 --obs-times-list 150 --n-sim-seqs-per-gen-list 150 --lb-tau-list 0.0025 --dont-observe-common-ancestors --choose-among-families
echo $bin --label choose-among-families-v4 --n-replicates 10 --n-sim-events-per-proc 150 $common --carry-cap-list 1500 --obs-times-list 150 --n-sim-seqs-per-gen-list 150 --lb-tau-list 0.0025 --dont-observe-common-ancestors --choose-among-families
echo $bin --label choose-among-families-v5 --n-replicates 10 --n-sim-events-per-proc 150 $common --carry-cap-list 1500 --obs-times-list 150 --n-sim-seqs-per-gen-list 150 --lb-tau-list 0.0025 --choose-among-families

# TODO remove --choose-among-families now that we plot it both ways by default
