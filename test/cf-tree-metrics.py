...
parser.add_argument('--metric-method', choices=['shm', 'fay-wu-h', 'consensus', 'delta-lbi', 'lbi-cons'], help='method/metric to compare to/correlate with affinity (for use with get-tree-metrics action). If not set, run partis to get lb metrics.')
