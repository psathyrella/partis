...
all_perf_metrics = ['precision', 'sensitivity', 'f1', 'time-reqd', 'naive-hdist', 'cln-frac', 'n-clusters', 'pairwise-prec', 'pairwise-sens', 'pairwise-f1', 'coar', 'rf', 'n-pars-trees']  # pcfrac-*: pair info cleaning correct fraction, cln-frac: collision fraction
