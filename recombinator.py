...
class Recombinator(object):
    ...
    def __init__(self, datadir, human, naivety):  # yes, with a y! motherfucker
        ...
        print '    reading version freqs from %s' % (datadir + '/' + human + '/' + naivety + '/probs.csv.bz2')
        self.read_vdj_version_freqs(datadir + '/' + human + '/' + naivety + '/probs.csv.bz2')
        print '    reading tree file'
        with opener('r')(datadir + '/' + human + '/' + naivety + '/trees.tre') as treefile:  # read in the trees that were generated by tree-gen.r
